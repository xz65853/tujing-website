...
async function main() {
  await prisma.siteSetting.upsert({
    ...
    create: {
      ...
      slogan: "实体企业线上增长服务商",
      description: "围绕抖音代运营、短视频、直播、本地生活、广告投放及电商运营，为实体企业提供线上内容、流量与获客解决方案。",
      phone: "0737-000-0000",
  ...
  await prisma.case.upsert({
    ...
    update: {},
    create: {
      title: "安化冰碛岩项目", slug: "anhua-ice-moraine", subtitle: "茶具 / 文创", industry: "茶具文创",
      projectType: "抖音运营 · 直播", summary: "围绕安化本地特色物产，搭建账号内容与直播体系。",
      ...
      dataVisible: false, featured: true, status: "published", categoryId: cc1.id,
      metrics: JSON.stringify([]), images: JSON.stringify([]),
    },
  });
  ...
  await prisma.case.upsert({
    ...
    update: {},
    create: {
      title: "安化黑茶项目", slug: "anhua-dark-tea", subtitle: "茶叶", industry: "茶叶",
      projectType: "短视频 + 直播 + 商品 + 投流", summary: "茶叶品类的内容电商与直播带货尝试。",
      ...
      dataVisible: false, featured: true, status: "published", categoryId: cc3.id,
      metrics: JSON.stringify([]), images: JSON.stringify([]),
    },
  });
  ...
  await prisma.case.upsert({
    ...
    update: {},
    create: {
      title: "本地实体商家", slug: "local-store", subtitle: "餐饮 / 汽车 / 装修 / 工厂", industry: "本地实体",
      projectType: "抖音本地生活 + 短视频 + 团购", summary: "帮助本地门店通过短视频与团购获得到店客流。",
      ...
      dataVisible: false, featured: false, status: "published", categoryId: cc2.id,
      metrics: JSON.stringify([]), images: JSON.stringify([]),
    },
  });
  ...
  await prisma.article.upsert({
    ...
    update: {},
    create: {
      title: "抖音代运营到底在运营什么？", slug: "douyin-operation-what-is-it",
      summary: "代运营不是简单代发视频，而是围绕业务目标做定位、内容、数据与转化的系统工程。",
      content: "## 一、定位\n\n先想清楚账号要吸引谁、卖什么、凭什么被记住。\n\n## 二、内容\n\n围绕目标客户的问题做选题，而不是自说自话。\n\n## 三、数据与转化\n\n播放量只是过程指标，真正要盯的是咨询与成交。",
      author: "途鲸内容组", publishedAt: new Date(), status: "published", categoryId: ac.id,
    },
  });
